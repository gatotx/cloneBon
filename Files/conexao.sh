...
if netstat -nltp|grep 'squid' 1>/dev/null 2>/dev/null;then
	...
	echo ""
	echo -ne "\033[1;32mREALMENTE DESEJA REMOVE O SQUID \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resp
	if [[ "$resp" = 's' ]]; then
...
clear
echo -e "\E[44;1;37m              INSTALLEDR SQUID                \E[0m"
echo ""
...
echo ""
fun_bar 'sqd_conf'
echo -e "\n\033[1;32mSQUID INSTALLED COM SUCCESS!\033[0m"
sleep 3.5s
fun_conexao
fi
}
...
addpt_sqd () {
	...
	if [[ -f "/etc/squid/squid.conf" ]]; then
		...
		echo -e "\n\033[1;31mSQUID NAO ESTA INSTALLED!\033[0m"
		echo -e "\n\033[1;31mReturning...\033[0m"
		sleep 2
		clear
		fun_squid
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mALTERAR PORT DROPBEAR\033[0m"
		...
		clear
		echo -e "\E[44;1;37m           INSTALLEDR DROPBEAR              \E[0m"
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
    ...
    echo ""
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mALTERAR PORT SSL TUNNEL\033[0m"
	...
	clear
	echo -e "\E[44;1;37m           INSTALLEDR SSL TUNNEL             \E[0m"
	...
	echo ""
	read -p "$(echo -e "\033[1;32mQUAL PORT DESEJA UTILIZAR? \033[1;37m")" -e -i 3128 PORT
	if [[ -z "$PORT" ]]; then
		echo ""
		echo -e "\033[1;31mPORT invalid!"
		sleep 3
    ...
    echo -e "\n\033[1;32mSSL TUNNEL INSTALLED COM SUCCESS !\033[1;31m PORT: \033[1;33m$PORT\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo ""
		echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mALTERAR PORT"
		...
		case $option in
			1) 
			clear
			echo -e "\E[44;1;37m         ALTERAR PORT OPENVPN         \E[0m"
			echo ""
			...
			2) 
			echo ""
			echo -ne "\033[1;32mDESEJA REMOVE O OPENVPN \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read REMOVE
			if [[ "$REMOVE" = 's' ]]; then
				rmv_open () {
	...
	clear
	echo -e "\E[44;1;37m              INSTALLEDR OPENVPN               \E[0m"
	echo ""
	# OpenVPN INSTALLEDr e criação do primeiro usuario
	...
	echo ""
	read -p "$(echo -e "\033[1;32mQUAL PORT DESEJA UTILIZAR? \033[1;37m")" -e -i 1194 PORT
	if [[ -z "$PORT" ]]; then
				echo ""
				echo -e "\033[1;31mPORT invalid!"
				sleep 3
...
exit 0' > $RCLOCAL
	...
	echo -e "\033[1;32mINSTALLING O OPENVPN  \033[1;31m(\033[1;33mPODE DEMORAR!\033[1;31m)"
	echo ""
	fun_bar 'fun_dep'
...
float" > /etc/openvpn/client-common.txt
	...
	newclient "SSHPLUS"
	echo ""
	echo -e "\033[1;32mOPENVPN INSTALLED COM SUCCESS\033[0m"
fi
...
fun_sslh () {
 [[ "$(netstat -nltp|grep 'sslh' |wc -l)" = '0' ]] && {
    clear
    echo -e "\E[44;1;37m             INSTALLEDR SSLH               \E[0m\n"
    echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mA PORT \033[1;37m443 \033[1;32mSERA USADA POR PADRAO\033[0m\n"
	echo -ne "\033[1;32mREALLY WANTS TO INSTALL SSLH \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resp
	if [[ "$resp" = 's' ]]; then
        verif_ptrs 443
        fun_instsslh () {
	...
	echo -ne "\033[1;32mREALLY WISH TO REMOVE SSLH \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read respo
    if [[ "$respo" = "s" ]]; then
	    fun_delsslh () {
