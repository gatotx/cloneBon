...
for pton in `echo -e "$PT" | cut -d: -f2 | cut -d' ' -f1 | uniq`; do
    ...
    [[ "$PORT" = "$pton" ]] && {
    	echo -e "\n\033[1;31mPORT \033[1;33m$PORT \033[1;31mEM USO PELO \033[1;37m$svcs\033[0m"
    	sleep 3
    	fun_conexao
    }
done
...
if netstat -nltp|grep 'squid' 1>/dev/null 2>/dev/null;then
	...
	echo ""
	echo -ne "\033[1;32mREALLY WISHES REMOVE O SQUID \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read resp
	if [[ "$resp" = 'y' ]]; then
		echo -e "\n\033[1;32mREMOVING O SQUID PROXY !\033[0m"
		echo ""
		rem_sqd () 
		{
		if [[ -d "/etc/squid/" ]]; then
	    ...
	    fun_bar 'rem_sqd'
		echo -e "\n\033[1;32mSQUID REMOVIDO COM SUCCESS !\033[0m"
		sleep 3.5s
		clear
		fun_conexao
	else
...
clear
echo -e "\E[44;1;37m              JOKER TEAM JOKER TEAM INSTALLER SQUID                \E[0m"
echo ""
...
echo -e "\n\033[1;33mQUAIS PORTS DESEJA ULTILIZAR NO SQUID \033[1;31m?"
echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mDEFINA AS PORTS EM SEQUENCIA \033[1;33mEX: \033[1;37m80 8080 8799"
echo ""
echo -ne "\033[1;32mINFORME AS PORTS\033[1;37m: "; read PORTss
if [[ -z "$PORTss" ]]; then
	echo -e "\n\033[1;31mPORT invalid!"
	sleep 3
	fun_conexao
fi
for PORT in $(echo -e $PORTss); do
	verif_ptrs $PORT
done
echo -e "\n\033[1;32mINSTALANDO SQUID PROXY\033[0m"
echo ""
fun_bar 'apt-get update -y' 'apt-get JOKER TEAM INSTALL squid3 -y'
sleep 1
if [[ -d "/etc/squid/" ]]; then
...
echo ""
fun_bar 'sqd_conf'
echo -e "\n\033[1;32mSQUID JOKER TEAM INSTALLED COM SUCCESS!\033[0m"
sleep 3.5s
fun_conexao
fi
}
...
addpt_sqd () {
	echo -e "\E[44;1;37m         ADD PORT AO SQUID         \E[0m"
	...
	if [[ -f "/etc/squid/squid.conf" ]]; then
		...
		echo -e "\n\033[1;31mSQUID NAO ESTA JOKER TEAM INSTALLED!\033[0m"
		echo -e "\n\033[1;31mReturning...\033[0m"
		sleep 2
		clear
		fun_squid
	fi
	echo -ne "\033[1;32mWHICH PORT DOES ADD WANT \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mPORT invalid!"
		sleep 3
		clear
	...
	verif_ptrs $pt
	echo -e "\n\033[1;32mADDING PORT AO SQUID!"
	echo ""
	sed -i "s/#PORTs/#PORTs\nhttp_port $pt/g" $var_sqd
	fun_bar 'sleep 2'
	echo -e "\n\033[1;32mRESTARTING O SQUID!"
	echo ""
	fun_bar 'service squid restart' 'service squid3 restart'
	echo -e "\n\033[1;32mPORT ADICIONADA COM SUCCESS!"
	sleep 3
	clear
	fun_squid
}
...
rempt_sqd () {
	echo -e "\E[41;1;37m        REMOVE PORT DO SQUID        \E[0m"
	echo -e "\n\033[1;33mPORTS EM USO: \033[1;32m$sqdp\n"
	if [[ -f "/etc/squid/squid.conf" ]]; then
		var_sqd="/etc/squid/squid.conf"
	elif [[ -f "/etc/squid3/squid.conf" ]]; then
	...
	echo -ne "\033[1;32mQUAL PORT DESEJA REMOVE \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mPORT invalid!"
		sleep 2
		clear
	...
	if grep -E "$pt" $var_sqd > /dev/null 2>&1; then
		echo -e "\n\033[1;32mREMOVING PORT DO SQUID!"
		echo ""
		...
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32mPORT REMOVED WITH SUCCESS!"
		sleep 3.5s
		clear
		fun_squid
	else
		echo -e "\n\033[1;31mPORT \033[1;32m$pt \033[1;31mNAO ENCONTRADA!"
		sleep 3.5s
		clear
		fun_squid
	fi
...
echo -e "\E[44;1;37m          TO MANAGE SQUID PROXY           \E[0m"
...
case $x in
	...
	;;
	*)
	echo -e "\033[1;31mOption invalid...\033[0m"
	sleep 2
	fun_conexao
	;;
	esac
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		echo -e "\E[44;1;37m              TO MANAGE DROPBEAR               \E[0m"
		...
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mCHANGE PORT DROPBEAR\033[0m"
		...
		if [[ "$resposta" = '1' ]]; then
			...
			if ps x | grep "limiter"|grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo -e "\n\033[1;31m LIMITER DISABLE \033[0m"
				sleep 3
				fun_drop
			else
				echo -e "\n\033[1;32mINVALID o limiter... \033[0m"
				echo ""
			...
			echo ""
			echo -ne "\033[1;32mQUAL PORT DESEJA ULTILIZAR \033[1;33m?\033[1;37m "; read pt
			echo ""
			verif_ptrs $pt
			var1=$(sed -n '6 p' /etc/default/dropbear)
			echo -e "\033[1;32mALTERANDO PORT DROPBEAR!"
			...
			echo -e "\n\033[1;32mPORT ALTERADA COM SUCCESS!"
			sleep 3
			clear
			fun_conexao
		elif [[ "$resposta" = '3' ]]; then
			echo -e "\n\033[1;32mREMOVING O DROPBEAR !\033[0m"
			echo ""
			fun_dropunistall () {
			...
			echo -e "\n\033[1;32mDROPBEAR REMOVIDO COM SUCCESS !\033[0m"
			sleep 3
			clear
			fun_conexao
		...
		clear
		echo -e "\E[44;1;37m           JOKER TEAM JOKER TEAM INSTALLER DROPBEAR              \E[0m"
		echo -e "\n\033[1;33mVC ESTA PRESTES A INSTALAR O DROPBEAR !\033[0m\n"
		echo -ne "\033[1;32mDESEJA CONTINUAR \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read resposta
		if [[ "$resposta" = 'y' ]]; then
			echo -e "\n\033[1;33mDEFINA UMA PORT PARA O DROPBEAR !\033[0m\n"
			echo -ne "\033[1;32mQUAL A PORT \033[1;33m?\033[1;37m "; read PORT
			if [[ -z "$PORT" ]]; then
				echo -e "\n\033[1;31mPORT invalid!"
				sleep 3
				clear
			...
			fun_instdrop () {
				dpkg --configure -a
				apt-get update -y
				apt-get JOKER TEAM INSTALL dropbear -y
			}
			...
			echo ""
			echo -e "\033[1;32mCONFIGURANDO PORT DROPBEAR !\033[0m"
			echo ""
			fun_bar 'fun_ports'
			...
			echo -e "\n\033[1;32mINSTALACAO CONCLUIDA \033[1;33mPORT: \033[1;37m$PORT\033[0m"
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
    ...
    echo -e "\E[44;1;37m              TO MANAGE SSL TUNNEL               \E[0m"
    ...
    echo ""
    if [[ "$resposta" = '1' ]]; then
    echo -ne "\033[1;32mQUAL PORT DESEJA ULTILIZAR \033[1;33m?\033[1;37m "; read PORT
    echo ""
	if [[ -z "$PORT" ]]; then
		echo ""
	...
	verif_ptrs $PORT
	echo -e "\033[1;32mALTERANDO PORT SSL TUNNEL!"
	var2=$(sed -n '9 p' /etc/stunnel/stunnel.conf)
	sed -i "s/$var2/accept = $PORT/g" /etc/stunnel/stunnel.conf > /dev/null 2>&1
	echo ""
	fun_bar 'sleep 3'
	echo ""
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mPORT ALTERADA COM SUCCESS !" || echo -e "\033[1;31mERRO INESPERADO!"
	sleep 3.5s
	clear
	fun_conexao
	fi
	if [[ "$resposta" = '2' ]]; then
		echo -e "\033[1;32mREMOVING O  SSL TUNNEL !\033[0m"
		del_ssl () {
		...
		fun_bar 'del_ssl'
		echo ""
		echo -e "\033[1;32mSSL TUNNEL REMOVIDO COM SUCCESS!\033[0m"
		sleep 3
		fun_conexao
	else
		echo -e "\033[1;31mReturning...\033[0m"
	...
	clear
	echo -e "\E[44;1;37m           JOKER TEAM JOKER TEAM INSTALLER SSL TUNNEL             \E[0m"
	echo -e "\n\033[1;33mVC ESTA PRESTES A INSTALAR O SSL TUNNEL !\033[0m"
	echo ""
	echo -ne "\033[1;32mDESEJA CONTINUAR \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read resposta
	if [[ "$resposta" = 'y' ]]; then
	echo -e "\n\033[1;33mDEFINA UMA PORT PARA O SSL TUNNEL !\033[0m"
	echo ""
	read -p "$(echo -e "\033[1;32mWHICH PORT DO YOU WANT TO USE? \033[1;37m")" -e -i 3128 PORT
	if [[ -z "$PORT" ]]; then
		echo ""
		echo -e "\033[1;31mPORT invalid!"
		sleep 3
	...
	echo ""
	fun_bar 'apt-get update -y' 'apt-get JOKER TEAM INSTALL stunnel4 -y'
    ...
    fun_bar 'ssl_certif'
    echo -e "\n\033[1;32mINVALID O SSL TUNNEL !\033[0m"
    echo ""
    fun_finssl () {
    ...
    echo -e "\n\033[1;32mSSL TUNNEL JOKER TEAM INSTALLED COM SUCCESS !\033[1;31m PORT: \033[1;33m$PORT\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo -e "\E[44;1;37m          TO MANAGE OPENVPN           \E[0m"
		echo ""
		...
		case $option in
			...
			echo ""
			echo -ne "\033[1;32mQUAL PORT DESEJA UTILIZAR \033[1;33m?\033[1;37m "; read PORT
			if [[ -z "$PORT" ]]; then
				echo ""
				echo -e "\033[1;31mPORT invalid!"
				sleep 3
			...
			verif_ptrs
			echo ""
			echo -e "\033[1;32mALTERANDO A PORT OPENVPN!\033[1;33m"
			echo ""
			fun_opn () {
			var_ptovpn=$(sed -n '1 p' /etc/openvpn/server.conf)
			sed -i "s/$var_ptovpn/port $PORT/g" /etc/openvpn/server.conf
			sleep 1 
			var_ptovpn2=$(sed -n '7 p' /etc/openvpn/client-common.txt | awk {'print $NF'})
			sed -i "s/$var_ptovpn2/ $PORT/g" /etc/openvpn/client-common.txt
			sleep 1
			service openvpn restart
		    }
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mPORT ALTERADA COM SUCCESS!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
			echo ""
			echo -ne "\033[1;32mDESEJA REMOVE O OPENVPN \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read REMOVE
			if [[ "$REMOVE" = 'y' ]]; then
				rmv_open () {
			    ...
			    echo ""
			    echo -e "\033[1;32mREMOVING O OPENVPN!\033[0m"
			    echo ""
			    fun_bar 'rmv_open'
				echo ""
				echo -e "\033[1;32mOPENVPN REMOVIDO COM SUCCESS!\033[0m"
				sleep 3
				fun_conexao
			else
				echo ""
            ...
            if [ -d /var/www/html/openvpn ] > /dev/nell; then
                ...
                function WAIT {
                	...
                	echo -ne "\033[1;31mDEAVACTING\033[1;32m.\033[1;33m.\033[1;31m. \033[1;33m"
                	helice
                	echo -e "\e[1DOk"
                }
                WAIT
            	...
            	clear
            	fun_apchon () {
            		apt-get JOKER TEAM INSTALL apache2 zip -y
            ...
            5)
            clear
            echo -e "\E[44;1;37m         CHANGE HOST DNS           \E[0m"
			echo ""
			...
			if [[ "$resp" = '1' ]]; then
				...
				echo ""
				echo -e "\E[44;1;37m      Host adicionado com SUCCESS !      \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '2' ]]; then
				clear
				...
				if [[ -z $option ]]; then
					echo ""
					echo -e "\E[41;1;37m          Option invalid  !        \E[0m"
					sleep 2
					fun_openvpn
				fi
				...
				echo "$hst" > /etc/hosts
				echo ""
				echo -e "\E[41;1;37m      Host removido com SUCCESS !      \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '3' ]]; then
			    ...
			    clear
			    nano /etc/hosts
			    echo -e "\n\033[1;32mALTERADO COM SUCCESS!\033[0m"
			    sleep 3
			    fun_openvpn
			elif [[ "$resp" = '0' ]]; then
				echo ""
	...
	clear
	echo -e "\E[44;1;37m              JOKER TEAM JOKER TEAM INSTALLER OPENVPN               \E[0m"
	echo ""
	# OpenVPN JOKER TEAM JOKER TEAM INSTALLER e criação do primeiro usuario
	echo -e "\033[1;33mANSWER THE QUESTIONS TO START JOKER TEAM INSTALLATION"
	echo ""
	...
	echo ""
	read -p "$(echo -e "\033[1;32mWHICH PORT DO YOU WANT TO USE? \033[1;37m")" -e -i 1194 PORT
	if [[ -z "$PORT" ]]; then
				echo ""
				echo -e "\033[1;31mPORT invalid!"
				sleep 3
	...
	echo ""
	read -p "$(echo -e "\033[1;32mWHAT DNS DO YOU WANT TO USE? \033[1;37m")" -e -i 2 DNS
	echo ""
	...
	echo ""
	if [[ "$OS" = 'debian' ]]; then
		echo -e "\033[1;32mAUPDATING THE SYSTEM "
		echo ""
		fun_attos () {
		apt-get update-y
		apt-get upgrade -y
	    ...
	    fun_bar 'fun_attos'
		echo ""
		echo -e "\033[1;32mJOKER TEAM INSTALLING DEPENDENCES "
		echo ""
		fun_instdep () {
		apt-get JOKER TEAM INSTALL openvpn iptables openssl ca-certificates -y
		apt-get JOKER TEAM INSTALL zip -y
	    }
	    fun_bar 'fun_instdep'
	else
		# Else, the distro is CentOS
		fun_bar 'yum JOKER TEAM INSTALL epel-release -y'
		fun_bar 'yum JOKER TEAM INSTALL openvpn iptables openssl wget ca-certificates -y'
	fi
...
exit 0' > $RCLOCAL
		...
		if sestatus | grep "Current mode" | grep -qs "enforcing"; then
			if [[ "$PORT" != '1194' || "$PROTOCOL" = 'tcp' ]]; then
				...
				if ! hash semanage 2>/dev/null; then
					yum JOKER TEAM INSTALL policycoreutils-python -y
				fi
	...
	echo -e "\033[1;32mJOKER TEAM INSTALLING O OPENVPN  \033[1;31m(\033[1;33mIT CAN TAKE TIME!\033[1;31m)"
	echo ""
	fun_bar 'fun_dep'
	...
	echo ""
	echo -e "\033[1;32mRESTARTING O OPENVPN"
	echo ""
	fun_bar 'fun_ropen'
...
remote /SSHPLUS? $PORT
http-proxy-option CUSTOM-HEADER Host PORTlrecarga.vivo.com.br/recarga
http-proxy $IP 80
resolv-retry 5
nobind
persist-key
...
float" > /etc/openvpn/client-common.txt
	...
	newclient "SSHPLUS"
	echo ""
	echo -e "\033[1;32mOPENVPN JOKER TEAM INSTALLED COM SUCCESS\033[0m"
fi
...
fun_socks () {
	clear
    echo -e "\E[44;1;37m            TO MANAGE PROXY SOCKS             \E[0m"
    echo ""
	...
	echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mABRIR PORT\033[0m"
	echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mCHANGE STATUS\033[0m"
	echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
	echo ""
	echo -ne "\033[1;32mWHAT DO YOU WANT TO DO \033[1;33m?\033[1;37m "; read resposta
	if [[ "$resposta" = '1' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo -e "\033[1;32mDEAVACTING O PROXY SOCKS\033[1;33m"
			echo ""
			fun_bar 'fun_socksoff'
			echo ""
			echo -e "\033[1;32mPROXY SOCKS DISABLE COM SUCCESS!\033[1;33m"
			sleep 3
			fun_socks
		else
			clear
		    ...
		    fun_inisocks () {
		    	sleep 1
		    	screen -dmS proxy python /etc/SSHPlus/proxy.py $PORT
		    	[[ $(grep -wc "proxy.py" /etc/autostart) = '0' ]] && {
		    		echo -e "netstat -tlpn | grep python > /dev/null && echo 'ON' || screen -dmS proxy python /etc/SSHPlus/proxy.py $PORT" >> /etc/autostart
		    	} || {
		            sed -i '/proxy.py/d' /etc/autostart
		            echo -e "netstat -tlpn | grep python > /dev/null && echo 'ON' || screen -dmS proxy python /etc/SSHPlus/proxy.py $PORT" >> /etc/autostart
		        }
		    ...
		    echo ""
		    echo -e "\033[1;32mINVALID O PROXY SOCKS\033[1;33m"
		    echo ""
		    fun_bar 'fun_inisocks'
		    echo ""
		    echo -e "\033[1;32mPROXY SOCKS ACTIVADED SUCCESS\033[1;33m"
		    sleep 3
		    fun_socks
		fi
	elif [[ "$resposta" = '2' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo -e "\E[44;1;37m            PROXY SOCKS             \E[0m"
			echo ""
			echo -e "\033[1;33mPORTS EM USO: \033[1;32m$sockspt"
			echo ""
			echo -ne "\033[1;32mQUAL PORT DESEJA ULTILIZAR \033[1;33m?\033[1;37m: "; read PORT
			if [[ -z "$PORT" ]]; then
				echo ""
			...
			verif_ptrs $PORT
			echo ""
			echo -e "\033[1;32mINVALID O PROXY SOCKS NA PORT \033[1;31m$PORT\033[1;33m"
			echo ""
			abrirptsks () {
				sleep 1
				screen -dmS proxy python /etc/SSHPlus/proxy.py $PORT
			...
			fun_bar 'abrirptsks'
			echo ""
			echo -e "\033[1;32mPROXY SOCKS ATIVADO COM SUCCESS\033[1;33m"
			sleep 3
			fun_socks
		else
			clear
		...
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo""
			echo -ne "\033[1;32mINFORM YOU STATUS\033[1;31m:\033[1;37m "; read msgg
			if [[ -z "$msgg" ]]; then
				echo ""
			...
			echo ""
			echo -e "\033[1;32mSTATUS CHANGED WITH SUCCESS!"
			sleep 3
			fun_socks
		else
			clear
...
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
	...
	if [[ "$resp" = '1' ]]; then
		clear
		echo -e "\E[44;1;37m         ADD PORT AO SSH         \E[0m\n"
		echo -ne "\033[1;32mWHICH PORT DOES ADD WANT \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPORT invalid!"
			sleep 3
		...
		verif_ptrs $pt
		echo -e "\n\033[1;32mADDING PORT AO SSH\033[0m"
		echo ""
		fun_addpssh () {
		...
		fun_bar 'fun_addpssh'
		echo -e "\n\033[1;32mPORT ADICIONADA COM SUCCESS\033[0m"
		sleep 3
		fun_conexao
	elif [[ "$resp" = '2' ]]; then
		clear
		echo -e "\E[41;1;37m         REMOVE PORT DO SSH         \E[0m"
		echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mPORT PADRAO \033[1;37m22 \033[1;33mCUIDADO !\033[0m"
		echo -e "\n\033[1;33mPORTS EM USO: \033[1;37m$(grep 'Port' /etc/ssh/sshd_config|cut -d' ' -f2 |grep -v 'no' |xargs)\n"
		echo -ne "\033[1;32mQUAL PORT DESEJA REMOVE \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPORT invalid!"
			sleep 3
		...
		[[ $(grep -wc "$pt" '/etc/ssh/sshd_config') != '0' ]] && {
			echo -e "\n\033[1;32mREMOVING PORT DO SSH\033[0m"
			echo ""
			fun_delpssh () {
			...
			fun_bar 'fun_delpssh'
			echo -e "\n\033[1;32mPORT REMOVED WITH SUCCESS\033[0m"
			sleep 3
			fun_conexao
		} || {
			echo -e "\n\033[1;31mPORT invalid!"
...
fun_sslh () {
 [[ "$(netstat -nltp|grep 'sslh' |wc -l)" = '0' ]] && {
    clear
    echo -e "\E[44;1;37m             JOKER TEAM JOKER TEAM INSTALLER SSLH               \E[0m\n"
    echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mA PORT \033[1;37m443 \033[1;32mSERA USADA POR PADRAO\033[0m\n"
	echo -ne "\033[1;32mREALLY WANTS TO JOKER TEAM INSTALL SSLH \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read resp
	if [[ "$resp" = 'y' ]]; then
        verif_ptrs 443
        fun_instsslh () {
    ...
    clear
    echo -e "\E[41;1;37m             REMOVE O SSLH               \E[0m\n"
	echo -ne "\033[1;32mREALLY WISH TO REMOVE SSLH \033[1;31m? \033[1;33m[y/n]:\033[1;37m "; read respo
    if [[ "$respo" = "y" ]]; then
	    fun_delsslh () {
	    ...
	    echo -e "\n\033[1;32mREMOVE SSLH !\033[0m\n"
	    fun_bar 'fun_delsslh'
	    echo -e "\n\033[1;32mREMOVED  SUCESS !\033[0m\n"
	    sleep 2
	    fun_conexao
    else
	     echo -e "\n\033[1;31mReturning.."
...
do
clear
echo -e "\E[44;1;37m      JOKER TEAM   EDIT PORT / ADD PORT              \E[0m\n"
...
case $x in
	...
	;;
	0|00)
	echo -e "\033[1;31mBack menu...\033[0m"
	sleep 2
	clear
	exit;
	;;
...
fun_conexao
	...
	rm -rf /bin/criarusuario /bin/expcleaner /bin/sshlimiter /bin/addhost /bin/listar /bin/sshmonitor /bin/ajuda /bin/menu /bin/OpenVPN /bin/userbackup /bin/tcpspeed /bin/badvpn /bin/otimizar /bin/speedtest /bin/trafego /bin/banner /bin/limit /bin/Usercreate /bin/senharoot /bin/reiniciarservicos /bin/reiniciarsistema /bin/attscript /bin/criarteste /bin/socks  /bin/DropBear /bin/CHANGElimite /bin/CHANGEsenha /bin/remover /bin/detalhes /bin/mudardata /bin/botssh /bin/versao > /dev/null 2>&1
